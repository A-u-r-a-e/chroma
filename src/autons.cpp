...
void red_solo_long(EncodersIMU &odom, MotionController &pilot) {
    ...
    // 46, 220, -17
    // 52.5, 270º, 10, -31.7
    pilot.move_by(46, 1500, -1, true);
    pilot.turn_to(to_rad(270), 800, true);
    loader_state = Pneumatic::EXTENDED;
    body_state = Body::I_STORAGE;
    pilot.move_by(13, 1000, -1, true);
    delay_for(500);
    pilot.move_by(-30.5, 1500, -1, true);
    loader_state = Pneumatic::RETRACTED;
    body_state = Body::S_FULL;
    ...
    // pilot.move_by(7, 800, -1, true);
    // pilot.turn_to(to_rad(155), 600, true);
    // pilot.move_by(30, 1000, -1, true);
    pilot.turn_to(to_rad(160), 1500, true);
    pilot.move_by(10, 600, -1, true);


    pilot.turn_to(to_rad(187), 1000, true);
    pros::lcd::print(5, "%f", to_deg(odom.get_pose().dir));
    pilot.move_by(52, 1500, -1, true);
    // pilot.move_by(-, 500, -1, true);
    loader_state = Pneumatic::EXTENDED;
    pilot.turn_to(to_rad(225), 750, true);
    loader_state = Pneumatic::RETRACTED;
    pilot.move_by(-17, 2000, -1, true); //revert to 16 for long goal route
    ...
    loader_state = Pneumatic::EXTENDED;
    pilot.move_by(51, 1500, -1, true);
    pilot.turn_to(to_rad(270), 750, true);
    // pilot.move_by(13, 800, -1, true);
    // delay_for(750);
    // pilot.move_by(-29.7, 1500, -1, true);
    pilot.move_by(-18, 800, -1, true);
    body_state = Body::M_REFRESH;
    delay_for(200);
    body_state = Body::S_FULL;
    delay_for(1500);
